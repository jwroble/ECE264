...
{   
    int tempSum; //Stores a temporary value of the sum of the elements in the array
...
int isIncreasing(int * array, int length)
{
    ...
    tempHigh = array[length];
    tempLow = array[length - 1];
    
    while(length >= 1 && check == 1)
    {
